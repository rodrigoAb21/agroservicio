...
class InsecticidaController extends Controller
{
    public function index()
    {
        return view('vistas.insumos.agroquimicos.insecticidas.index',
            [
                'insumos' => Insumo::where('insumo.tipo','=', 'Agroquimico')
                    ->where('insumo.subtipo_id', '=', 2)->get(),
            ]);
    }

    public function create()
    {
        return view('vistas.insumos.agroquimicos.insecticidas.create',
            [
    ...
    public function store(Agroquimico2Request $request)
    {
        ...
        return redirect('insumos/insecticidas')->with(['message' => $mensaje]);
    }

    public function edit($id)
    {
        return view('vistas.insumos.agroquimicos.insecticidas.edit',
            [
    ...
    {
        return view('vistas.insumos.agroquimicos.insecticidas.show',
            [
                'insumo' => Insumo::findOrFail($id),
                'detalles' => Composicion::where('insumo_id','=', $id)->get(),
            ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect('insumos/insecticidas')->with(['message' => 'Agroquímico eliminado exitosamente.']);
    }
}
