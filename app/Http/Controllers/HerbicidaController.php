...
class HerbicidaController extends Controller
{
    public function index()
    {
        return view('vistas.insumos.agroquimicos.herbicidas.index',
            [
                'insumos' => Insumo::where('insumo.tipo','=', 'Agroquimico')
                    ->where('insumo.subtipo_id', '=', 1)->get(),
            ]);
    }

    public function create()
    {
        return view('vistas.insumos.agroquimicos.herbicidas.create',
            [
    ...
    public function store(Agroquimico2Request $request)
    {
        ...
        return redirect('insumos/herbicidas')->with(['message' => $mensaje]);
    }

    public function edit($id)
    {
        return view('vistas.insumos.agroquimicos.herbicidas.edit',
            [
    ...
    {
        return view('vistas.insumos.agroquimicos.herbicidas.show',
            [
                'insumo' => Insumo::findOrFail($id),
                'detalles' => Composicion::where('insumo_id','=', $id)->get(),
            ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect('insumos/herbicidas')->with(['message' => 'Agroquímico eliminado exitosamente.']);
    }
}
