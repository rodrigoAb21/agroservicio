        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{url('insumos/herbicidas/'.$insumo->id)}}" autocomplete="off">
                        {{csrf_field()}}
                        {{method_field('PATCH')}}
                        <div class="row">
                        ...
                        <a href="{{url('insumos/herbicidas')}}" class="btn btn-warning">Atrás</a>
