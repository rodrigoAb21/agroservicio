    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h2 class="pb-2">
                            <i class="fa fa-biohazard"></i> Fungicidas
                        <div class="float-right">
                            <a class="btn btn-success" href="{{url('insumos/fungicidas/create')}}">
                            ...
                            @foreach($insumos as $insumo)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center" style="white-space: nowrap">
                                        <a href="{{url('insumos/fungicidas/'.$insumo->id)}}">
                                            <button class="btn btn-outline-info">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </a>
                                        <a href="{{url('insumos/fungicidas/'.$insumo->id.'/edit')}}">
                                            <button class="btn btn-warning">
                                                <i class="fa fa-pen"></i>
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-danger" onclick="modalEliminar('{{$insumo -> nombre}}', '{{url('insumos/fungicidas/'.$insumo -> id)}}');">
    ...
    @push('scripts')
        <script>
            ...
            function modalEliminar(nombre, url) {
                ...
                $('#metodo').val("delete");
                $('#modalEliminarTitulo').html("Eliminar Fungicida");
                $('#modalEliminarEnunciado').html("Realmente desea eliminar el fungicida: " + nombre + "?");
