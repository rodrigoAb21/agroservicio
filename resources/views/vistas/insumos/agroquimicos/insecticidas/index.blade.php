    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h2 class="pb-2">
                            <i class="fa fa-biohazard"></i> Insecticidas
                        <div class="float-right">
                            <a class="btn btn-success" href="{{url('insumos/insecticidas/create')}}">
                            ...
                            @foreach($insumos as $insumo)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center" style="white-space: nowrap">
                                        <a href="{{url('insumos/insecticidas/'.$insumo->id)}}">
                                            <button class="btn btn-outline-info">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </a>
                                        <a href="{{url('insumos/insecticidas/'.$insumo->id.'/edit')}}">
                                            <button class="btn btn-warning">
                                                <i class="fa fa-pen"></i>
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-danger" onclick="modalEliminar('{{$insumo -> nombre}}', '{{url('insumos/insecticidas/'.$insumo -> id)}}');">
    ...
    @push('scripts')
        <script>
            ...
            function modalEliminar(nombre, url) {
                ...
                $('#metodo').val("delete");
                $('#modalEliminarTitulo').html("Eliminar Insecticida");
                $('#modalEliminarEnunciado').html("Realmente desea eliminar el insecticida: " + nombre + "?");
